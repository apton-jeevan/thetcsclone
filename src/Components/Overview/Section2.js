                    ...
                    <div className="col-lg-6">
                        ...
                        <a href="https://www.tcs.com/what-we-do/industries/banking"
                            ...
                            <p className="industry-title">
                                <span className="industry-icon"><i class="fa-solid fa-dollar-sign"></i></span>
                                Banking
                                <span className="industry-arrow"><i class="fa-solid fa-arrow-right"></i></span>
                            </p>
                        </a>
                        <hr />
                    </div>
                    ...
                    <div className="col-lg-6">
                        ...
                        <a href="https://www.tcs.com/what-we-do/industries/capital-markets"
                            ...
                            <p className="industry-title">
                                <span className="industry-icon"><i class="fa-solid fa-dollar-sign"></i></span>
                                Capital Markets
                            <span className="industry-arrow"><i class="fa-solid fa-arrow-right"></i></span> </p>
                        </a><hr />
                    </div>
